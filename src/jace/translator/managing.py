...
_PRIMITIVE_TRANSLATORS_VIEW: types.MappingProxyType[str, translator.PrimitiveTranslator] = (
    types.MappingProxyType(_PRIMITIVE_TRANSLATORS_DICT)
)
...
def add_subtranslators(
    *subtrans: PrimitiveTranslator | None,
    ...
    global _PRIMITIVE_TRANSLATORS_VIEW
    ...
    new_PRIMITIVE_TRANSLATORS_DICT = _PRIMITIVE_TRANSLATORS_DICT.copy()
    ...
    for prim_trans in subtrans:
        ...
        if (prim_name in _PRIMITIVE_TRANSLATORS_DICT) and (not overwrite):
            raise ValueError(f"Tried to add a second translator for primitive '{prim_name}'.")

        # Commit the change to a "staging"
        new_PRIMITIVE_TRANSLATORS_DICT[prim_name] = prim_trans

    # Now update the global variables.
    #  Doing it after the loop gives us exception guarantee
    # TODO: We should consider creating some list of "subtranslators sets that are known to be stable"
    #           i.e. where generated by this function, this would allow better caching in some situation.
    _PRIMITIVE_TRANSLATORS_DICT = new_PRIMITIVE_TRANSLATORS_DICT
    _PRIMITIVE_TRANSLATORS_VIEW = types.MappingProxyType(_PRIMITIVE_TRANSLATORS_DICT)
...
def get_subtranslators(
    ...
    return _PRIMITIVE_TRANSLATORS_VIEW
